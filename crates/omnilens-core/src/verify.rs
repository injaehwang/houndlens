...
use anyhow::Result;
use omnilens_ir::contract::Contract;
use omnilens_ir::invariant::{InvariantViolation, ViolationSeverity};
...
pub struct SemanticChange {
    pub location: omnilens_ir::SourceSpan,
