//! HoundQL executor — evaluates parsed queries against the semantic graph.
...
/// Execute a parsed HoundQL query against the graph.
...
fn node_kind_str(node: &UsirNode) -> &str {
    match node {
        ...
        UsirNode::DataType(dt) => match dt.kind {
            houndlens_ir::node::DataTypeKind::Struct => "struct",
            houndlens_ir::node::DataTypeKind::Class => "class",
            houndlens_ir::node::DataTypeKind::Interface => "interface",
            houndlens_ir::node::DataTypeKind::Trait => "trait",
            houndlens_ir::node::DataTypeKind::Enum => "enum",
            houndlens_ir::node::DataTypeKind::Union => "union",
            houndlens_ir::node::DataTypeKind::TypeAlias => "typealias",
        },
